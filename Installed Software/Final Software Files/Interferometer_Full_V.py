...
class InterferometerApp:
    def __init__(self, master):
        ...
        logo_img = Image.open(r"C:\Users\Utente\Documents\Interferometer Data\UCT_Logo.png")
        ...
        self.ax_fringe.set_title("Observed Fringe Pattern: Relative Phase Shift Between Antenna Channels")
        self.ax_fringe.set_xlabel("Time [s]")
        self.ax_fringe.set_ylabel(r"Fringe Phase Difference $\phi$°")  # optional clarification

        # Middle: Correlation Coefficient
        self.ax_corr = self.fig.add_subplot(3, 1, 2)
        self.ax_corr.set_title("Observed Unnormalized Cross-Correlation Magnitude")
        self.ax_corr.set_xlabel("Time [s]")
        self.ax_corr.set_ylabel(r"Cross-Correlation Magnitude [arb. units]")
        ...
        self.ax_crosscorr.set_ylabel("|Cxy| (Normalized)")
    ...
    def update_plots(self):
        ...
        self.ax_crosscorr.set_title(f"Cross-Correlation of a {float(self.win_size.get())}-Second Chunk")
        self.ax_crosscorr.set_xlabel("Lag [μs]")
        ...
        self.ax_fringe.plot(np.rad2deg(Phase_Differences))
        self.ax_fringe.set_title("Observed Fringe Pattern: Relative Phase Shift Between Antenna Channels")
        self.ax_fringe.set_xlabel("Time [s]")
        self.ax_fringe.set_ylabel(r"Fringe Phase Difference $\phi$°")  # optional clarification
    ...
    def analyse_data(self):
        ...
        self.win_Resolution_var.set(f"Buffer size: {float(self.win_size.get())} s")
